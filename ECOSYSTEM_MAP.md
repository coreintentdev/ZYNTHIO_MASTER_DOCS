...
![Status](https://img.shields.io/badge/status-active-brightgreen) ![Updated](https://img.shields.io/badge/updated-2026--05--05-blue)
...
## Current State Snapshot — May 5, 2026
...
| Matter | State | Notes |
|--------|-------|-------|
| ZYNTHIO LIMITED — name reserved | Active | **7 days to incorporate (as of 2026-05-05) — filed Apr 21, confirmed processing Apr 22 — certificate CRITICALLY OVERDUE — TODAY Tue May 5 is BD11 — CALL Companies Office NOW** |
