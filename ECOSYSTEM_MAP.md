...
![Status](https://img.shields.io/badge/status-active-brightgreen) ![Updated](https://img.shields.io/badge/updated-2026--05--04-blue)
...
## Current State Snapshot — May 4, 2026
...
| Matter | State | Notes |
|--------|-------|-------|
| ZYNTHIO LIMITED — name reserved | Active | **8 days to incorporate (as of 2026-05-04) — filed Apr 21, confirmed processing Apr 22 — certificate CRITICALLY OVERDUE — TODAY Mon May 4 is BD10 — CALL Companies Office NOW** |
