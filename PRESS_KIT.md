...
![Status](https://img.shields.io/badge/status-submission--ready-brightgreen) ![Updated](https://img.shields.io/badge/updated-2026--05--07-blue)
...
Zynthio targets a ~$21B+ combined addressable market across music production, AI generation, education, and AI-assisted trading. The seed raise is NZD $150-250K. The moat: no competitor combines AI production, education, IP infrastructure, autonomous trading, and an artist persona under one sovereign architecture.
...
Corey McIvor is a NZ/AU dual citizen, full-stack developer, AI engineer, and independent music producer. He founded Zynthio — a seven-brand creative-technology ecosystem — and built every layer: the code, the AI orchestration, the brand architecture, the music, and the legal filings. Based in Managua, Nicaragua.
...
MOSOKO teaches independent creators the full stack. KERVALON protects every asset produced. Seven brands, one founder, one doctrine: *No filler. All signal.*
...
| CoreIntent primary wordmark | Pending | *(add URL)* |
...
1. Use "Zynthio" (capital Z) in editorial contexts — "ZYNTHIO" in legal/branding only
2. "SongPal" as two words with capitals — not "Songpal" or "Song Pal"
3. "CoreIntent" as one word with capital C and I — not "Core Intent" or "Coreintent"
4. Include TM symbol (SongPal™) in first mention within any document
5. DJ Zynrose is the artist name — "Corey McIvor" in non-artist contexts
6. Signal Gold (#C9A84C) is an accent, not a fill colour — use sparingly
7. Brand assets are copyright ZYNTHIO / Corey McIvor unless otherwise stated
