...
Zynthio is a sovereign AI-powered creative ecosystem built by Corey McIvor — a NZ/AU developer, producer, and AI engineer. Seven interconnected brands deliver AI music production, multi-model orchestration, education, IP protection, and autonomous competition-based trading. One founder. One stack. Incorporating in New Zealand, May 2026. No filler. All signal.

### The Medium Version (150 words)

Independent creators are fragmented across broken tooling — expensive AI platforms that extract value, education disconnected from real tools, and legal infrastructure they can't afford. AI trading is worse: black-box subscriptions with zero transparency. Zynthio solves both problems with one vertically integrated creative-technology ecosystem.
...
The founder, Corey McIvor, built the entire stack — the AI integrations, the Next.js frontends, the trading bot, the brand architecture, the music, and the legal filings. He is both the engineer and the artist. Every track released under DJ Zynrose is made using the same tools Zynthio builds for everyone.

### The Full Version (300 words)

The post-AI creative economy has a structural problem: the tools are getting better, but the infrastructure around them is getting worse. Independent creators can produce studio-quality music in minutes — but the platforms capturing that value give nothing back. Education hasn't caught up. Legal protection is inaccessible. AI trading is opaque and gatekept. The full pipeline from creation to ownership is broken.
...
The architecture is deliberate. SongPal is the flagship AI music production platform, with a trademark filed at IPONZ (#1318588). CoreeyAI is the intelligence layer — a purpose-built orchestration system routing tasks across Claude, Grok, Perplexity, and Suno. MOSOKO teaches independent creators the full stack. KERVALON handles IP protection. CoreIntent is the engineering arm, also operating gTrade — an autonomous, risk-managed trading bot using a competition-based model with open architecture and verifiable risk parameters. And DJ Zynrose is Corey's artist persona: the living proof that the stack works.
...
Corey McIvor is a NZ/AU dual citizen, full-stack developer, AI engineer, and independent music producer. He founded Zynthio — a seven-brand creative-technology ecosystem — and built every layer: the code, the AI orchestration, the trading bot, the brand architecture, the music, and the legal filings. Based in Managua, Nicaragua.

### Medium Bio (100 words)

Corey McIvor is the founder of Zynthio, a sovereign AI-powered creative ecosystem incorporating in New Zealand. A dual NZ/AU citizen based in Managua, Nicaragua, Corey is a full-stack developer and AI engineer who built the entire Zynthio stack solo — from multi-model AI orchestration (CoreeyAI) to a trademark-filed music production platform (SongPal) to an autonomous competition-based trading bot (gTrade) that self-funds development.

Under his artist name DJ Zynrose, Corey produces original electronic music using the same tools he builds — making him both the engineer and the proof of concept. His work spans AI, fintech, music production, education, and IP infrastructure.
...
MOSOKO teaches independent creators the full stack. KERVALON protects every asset. Seven brands, one founder, one doctrine: *No filler. All signal.*
...
> "We're not pitching a feature. We're pitching sovereign creative infrastructure for the post-AI world."
...
> "We don't burn cash while we build. gTrade funds development autonomously. That's sovereignty in practice."

> "The artist is the proof of concept. Every DJ Zynrose track is a live demo of the SongPal stack."

### On CoreIntent and gTrade:

> "AI trading shouldn't be a black box behind a subscription paywall. gTrade competes with open architecture and verifiable risk parameters. Performance is the product."
...
> "Open architecture means anyone can verify the risk parameters. Max 5x leverage, 1% risk per trade, 0.8% daily loss ceiling. Nothing hidden."
...
| Matrix Green | `#00FF41` | Primary accent — data, live systems |
| Electric Cyan | `#00D4FF` | AI/tech callouts |
| Steel Grey | `#2A2A2A` | Panel backgrounds |
...
| Trading engine | gTrade — competition-based, open architecture, autonomous |
...
|-------|--------|----------|
| ZYNTHIO primary wordmark | Pending | *(add URL when created)* |
| SongPal primary wordmark | Pending | *(add URL when created)* |
| CoreIntent primary wordmark | Pending | *(add URL when created)* |
| DJ Zynrose artist logo | Pending | *(add URL when created)* |
| Founder headshot | Pending | *(add URL when created)* |
...
1. Use "Zynthio" (capital Z) in editorial — "ZYNTHIO" only in legal or branding contexts
2. "SongPal" — two words, both capitalised. Not "Songpal" or "Song Pal"
3. "CoreIntent" — one word, capital C and I. Not "Core Intent"
4. Include TM symbol (SongPal&trade;) on first mention in any document
5. "DJ Zynrose" is the artist name — use "Corey McIvor" in non-artist contexts
6. Signal Gold (#C9A84C) is an accent, not a fill colour — use sparingly
7. Brand assets are copyright ZYNTHIO / Corey McIvor. Codebase is MIT-licensed; brand assets are not.

---

*Last updated: 2026-05-09 (Session 30) | Maintained by: Corey McIvor / COREINTENT*
